function genPerfMat(seqs, trackers, evalType, nameTrkAll, perfMatPath, annoPath, type)
...
switch evalType
    case 'SRE'
        rpAll=['.\results\results_SRE_',type,'\'];
    case 'TRE'
        rpAll=['.\results\results_TRE_',type,'\'];
    case 'OPE'
       rpAll=['.\results\results_OPE_',type,'\'];
%     case 'OPE'
