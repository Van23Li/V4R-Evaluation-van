...
paperTitle = 'ICRA19qikan_Van_HC'; % 针对的会议或期刊名称和作者
...
for typeNum = 1:length(typeOPE)
    ...
    metricType = typeOPE{typeNum};
    OJFiles = dir([AttPerfDataPath typeOPE{typeNum} '*OPE - *(*).mat']);
    
%     switch metricType
%         case 'Precision'
%             OJFiles = dir([AttPerfDataPath 'Precision plots of ' evalType ' - ' 'Precision plots.mat']);
%         case 'error'
%             OJFiles = dir([AttPerfDataPath 'Success plots of ' evalType ' - ' 'Success plots.mat']);
%     end
